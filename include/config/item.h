...
#define I_EXP_SHARE_FLAG        EXP_ALL_POKEMON // If this flag is set, every Pokémon in the party will gain experience, regardless if they participated in the battle or not.
