...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_CHIKORITA] =
    {
        ...
        .abilities = { ABILITY_MAGIC_GUARD, ABILITY_TRIAGE, ABILITY_LEAF_GUARD },
    ...
    [SPECIES_MEGANIUM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_MONSTER, EGG_GROUP_GRASS },
        .abilities = { ABILITY_SAP_SIPPER, ABILITY_TRIAGE, ABILITY_LEAF_GUARD },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_QUILAVA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_NO_GUARD, ABILITY_NONE, ABILITY_FLASH_FIRE },
        .bodyColor = BODY_COLOR_YELLOW,
...
#define TYPHLOSION_MISC_INFO                                            \
    ...
    [SPECIES_HOOTHOOT] =
    {
        ...
        .abilities = { ABILITY_INSOMNIA, ABILITY_CURSED_BODY, ABILITY_TINTED_LENS },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_LEDYBA] =
    {
        ...
        LEARNSETS(Ledyba),
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_LEDIAN}),
    },
    ...
    [SPECIES_SPINARAK] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_BUG },
        .abilities = { ABILITY_MOXIE, ABILITY_INSOMNIA, ABILITY_SNIPER },
        .bodyColor = BODY_COLOR_GREEN,
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 95 : 75)
    ...
    [SPECIES_AMPHAROS] =
    {
        ...
        .expYield = 230,
        .abilities = { ABILITY_STATIC, ABILITY_MOTOR_DRIVE, ABILITY_PLUS },
        .cryId = CRY_AMPHAROS,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_SUNKERN] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_SOLAR_POWER, ABILITY_EARLY_BIRD },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_SUNFLORA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_GRASS, EGG_GROUP_GRASS },
        .abilities = { ABILITY_STORM_DRAIN, ABILITY_SOLAR_POWER, ABILITY_EARLY_BIRD },
        .bodyColor = BODY_COLOR_YELLOW,
...
#define SNEASEL_MISC_INFO                                   \
    ...
    [SPECIES_WEAVILE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_PRESSURE, ABILITY_REFRIGERATE, ABILITY_PICKPOCKET },
        .bodyColor = BODY_COLOR_BLACK,
...
#define CORSOLA_MISC_INFO                                       \
    ...
    [SPECIES_OCTILLERY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_WATER_1, EGG_GROUP_WATER_2 },
        .abilities = { ABILITY_SUCTION_CUPS, ABILITY_COLOR_CHANGE, ABILITY_MOODY },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_HOUNDOUR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_EARLY_BIRD, ABILITY_FLASH_FIRE, ABILITY_DROUGHT },
        .bodyColor = BODY_COLOR_BLACK,
...
#define HOUNDOOM_MISC_INFO                                  \
    ...
    [SPECIES_LARVITAR] =
    {
        ...
        .abilities = { ABILITY_SAND_STREAM, ABILITY_NONE, ABILITY_GUTS},
        .bodyColor = BODY_COLOR_GREEN,
