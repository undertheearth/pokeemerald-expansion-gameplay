...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_CHIKORITA] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_NONE, ABILITY_MAGIC_GUARD },
    ...
    [SPECIES_LEDYBA] =
    {
        ...
        .abilities = { ABILITY_AIR_FORCE, ABILITY_AIR_FORCE, ABILITY_AIR_FORCE },
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_BONSLY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_STURDY, ABILITY_ROCK_HEAD, ABILITY_ADAPTABILITY },
        .bodyColor = BODY_COLOR_BROWN,
