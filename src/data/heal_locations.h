static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_DESERT_ROUTE111 - 1] = {MAP_GROUP(DESERT_ROUTE111), MAP_NUM(DESERT_ROUTE111), 51, 32},
    [HEAL_LOCATION_ARIDORIA_TOWN - 1] = {MAP_GROUP(ARIDORIA_TOWN), MAP_NUM(ARIDORIA_TOWN), 40, 36},
};
